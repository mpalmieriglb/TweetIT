...
var oauth = ChromeExOAuth.initBackgroundPage({
	...
	'consumer_key': '47FrXTWy5oRU59H62vfG6w',
	'consumer_secret': 'YlvRJNLgpJCHuy4rzfAoJVTamIFhsbT8V4Gwnu6Oo',
...
ChromeExOAuth.prototype.signURL = function(url, method, opt_params) {
  var token = "1037299597-OvRx7N5YjeCSmY9mrX5pyNeq7GmXXYVPZRqcs3a"; //this.getToken();
  var secret = "DW776xlpXaBjotlyV52ZzzGxqbzoVQTYUkaPYYIbc"; //this.getTokenSecret();
  if (!token || !secret) {
