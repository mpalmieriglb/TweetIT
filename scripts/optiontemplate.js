...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\" />\r\n    </div>\r\n\r\n    <div class=\"inputWrapper\">\r\n        <label>Update Interval</label>\r\n        <input type=\"text\" id=\"updateInterval\" placeholder=\"in milliseconds\" value=\"";
  if (helper = helpers.updateInterval) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.updateInterval); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
